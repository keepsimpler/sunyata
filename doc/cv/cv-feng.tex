...
\homepage{https://keepsimpler.github.io/smartfarming/}                         % optional, remove / comment the line if not wanted
...
\begin{itemize}
  ...
  \item Study on deep neural network architectures applying into computer vision and natural language processing, specially in smart farming. 
 \end{itemize}  
}
...
\newblock {\em in Electronics 2022}, 11, 3603.
