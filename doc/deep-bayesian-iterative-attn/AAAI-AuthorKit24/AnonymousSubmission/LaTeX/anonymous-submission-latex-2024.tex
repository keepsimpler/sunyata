...
\title{Improving Isotropic Neural Networks With Weight-shared Iterative Cross Attentions}
\author{
    %Authors
...
\affiliations{
    %Afiliations
    \textsuperscript{\rm 1}Department of Computer Science and Technology, Henan Polytechnic University\\
